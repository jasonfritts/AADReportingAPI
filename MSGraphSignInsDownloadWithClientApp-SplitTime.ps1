...
$url = "https://graph.microsoft.com/beta/auditLogs/signIns?`$filter=createdDateTime ge FROM_DATE and createdDateTime lt TO_DATE"
...
$outputFile = ".\AAD_SignInReport_DATE.csv"   #Output file location by default it is the location of script -- do not  remove 'DATE' part
